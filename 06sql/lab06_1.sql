...
-- Get the names and mandate statements of all teams along with the ID of their “chair” member.
-- If a chair member does not exist, include NULL for the ID.
SELECT T.name, T.mandate, PT.personID
FROM Team T
LEFT JOIN PersonTeam PT
