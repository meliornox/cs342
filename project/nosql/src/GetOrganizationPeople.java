...
public class GetOrganizationPeople {
    ...
    public static void run(Connection connection) throws SQLException {
        ...
        Key key = Key.createKey(Arrays.asList("movie", "92616"), Arrays.asList("personToOrg"));
        ...
        for (Map.Entry<Key, ValueVersion> field : fields.entrySet()) {
            ...
            Map<Key, ValueVersion> actor = store.multiGet(Key.createKey(Arrays.asList("person", personId)), null, null);
